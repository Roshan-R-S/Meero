...
COMMAND_ROUTE_SPECS = (
    ...
    CommandRouteSpec(name="volume", handler="volume_control", patterns=(r"\b(volume|mute)\b",)),
    ...
    CommandRouteSpec(name="tab", handler="tab_management", patterns=(r"new tab", r"close tab", r"next tab", r"previous tab", r"switch tab", r"close this tab")),
